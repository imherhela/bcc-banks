Locales["en_lang"] = {
    ...
    interest_rate_display = "Applied interest rate: %s%%",
    ...
    admin_view_locked_accounts_button = "Locked Accounts",
    ...
    admin_locked_accounts_header = "Locked Accounts",
    admin_locked_accounts_subheader = "Accounts frozen for this bank",
    admin_locked_accounts_empty = "No locked accounts for this bank.",
    admin_unlock_account_button = "Unlock Account",
    admin_unlock_account_success = "Account unlocked.",
    admin_unlock_account_failed = "Unable to unlock account.",
    admin_lock_account_button = "Lock Account",
    admin_lock_account_success = "Account locked.",
    admin_lock_account_failed = "Unable to lock account.",
    ...
    admin_delete_account_balance = "Withdraw all funds before deleting.",
    admin_force_delete_account_button = "Force Delete Account",
    admin_force_delete_account_success = "Account deleted (forced).",
    admin_force_delete_account_failed = "Unable to force delete account.",
    ...
    -- Checks UI
    checks_button = "Cash a Check",
    write_check_button = "Write a Check",
    view_issued_checks_button = "View Issued Checks",
    write_check_header = "Write a Check",
    write_check_subheader = "Funds are deducted from account immediately",
    check_recipient_label = "Recipient First Name",
    check_recipient_placeholder = "Enter first name",
    check_recipient_last_label = "Recipient Last Name",
    check_recipient_last_placeholder = "Enter last name",
    check_amount_label = "Check Amount",
    check_amount_placeholder = "Enter amount",
    check_memo_label = "Memo (optional)",
    check_memo_placeholder = "e.g. For services rendered",
    check_confirm_header = "Confirm Check",
    check_confirm_text = "Write check for $%s to %s %s?",
    check_written_notify = "Check written for $%s.",
    cash_check_header = "Cash a Check",
    cash_check_subheader = "Pending checks made out to you",
    no_checks_found = "No pending checks found.",
    check_label = "$%s (from %s %s)",
    check_cash_confirm_header = "Confirm Cash Check",
    check_cash_confirm_text = "Cash this check for $%s?",
    check_cashed_notify = "Check cashed for $%s.",
    issued_checks_header = "Issued Checks",
    issued_checks_subheader = "Checks written from this account",
    no_issued_checks_found = "No pending checks issued from this account.",
    issued_check_label = "$%s — to %s %s",
    void_check_button = "Void Check",
    check_void_confirm_header = "Confirm Void",
    check_void_confirm_text = "Void check for $%s? Funds will be returned to the account.",
    check_voided_notify = "Check voided. Funds returned to account.",
    invalid_check_amount = "Enter a valid check amount.",
    invalid_check_recipient = "Enter a valid recipient name.",
    ...
    error_loan_already_disbursed = "Loan funds have already been disbursed.",
    error_invalid_loan_claim = "Cannot transfer to this account.",
    ...
    loan_account_default_name = "Loan Account",
    ...
    loan_disbursement_desc = "Loan disbursed to account",
    loan_claim_transaction_desc = "Loan disbursed to account (claimed)",
    loan_repayment_cash_desc = "Loan repayment from character cash",
    loan_repayment_account_desc = "Loan repayment from account",
    loan_transactions_header = "Loan Transactions",
    loan_transactions_date = "Date",
    loan_transactions_type = "Type",
    loan_transactions_desc = "Description",
    loan_transactions_amount = "Amount",
    loan_transactions_empty = "No loan transactions recorded yet.",
    loan_transactions_button = "View Transactions",
    loan_paid_label = "Loan is fully repaid.",
    ...
    admin_pending_loans = "Pending Loans",
    admin_all_loans = "All Loans",
    ...
    mail_loan_approved_subject = "Loan Approved",
    mail_loan_approved_body_intro = "Your loan request has been approved.",
    mail_loan_approved_body_outro = "Visit the bank to access the funds.",
    mail_loan_rejected_subject = "Loan Rejected",
    mail_loan_rejected_body_intro = "Your loan request has been rejected.",
    mail_loan_rejected_body_outro = "Please contact the bank for details.",
    mail_amount_label = "Amount: ",
    ...
    error_invalid_check = "Invalid check.",
    error_check_not_yours = "This check is not made out to you.",
    error_check_already_cashed = "This check has already been cashed.",
    error_check_voided = "This check has been voided.",
    error_unable_write_check = "Unable to write check at this time.",
    error_insufficient_funds_check = "Insufficient account funds to write this check.",
    error_check_not_at_bank = "You must be at a bank to cash a check.",
    error_check_no_permission_void = "You do not have permission to void this check.",
}
